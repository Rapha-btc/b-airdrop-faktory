...
def save_clean_csv(addresses, output_path):
    """Save clean addresses to CSV file"""
...
def clean_addresses(csv_path):
    ...
    try:
        ...
        # Save clean CSV
        save_clean_csv(addresses, 'clean_addresses.csv')
...
def main():
    ...
    print(f"Clean CSV saved to: clean_addresses.csv")
